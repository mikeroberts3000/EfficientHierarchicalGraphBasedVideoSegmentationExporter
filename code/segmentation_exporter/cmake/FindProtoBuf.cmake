...
ELSE (PROTOBUF_LIBRARY AND PROTOBUF_INCLUDE_DIR AND PROTOBUF_PROTOC_EXECUTABLE)
  ...
  message("PROTO LIB: ${PROTOBUF_LIBRARY}")
...
IF (PROTOBUF_FOUND)
  ...
  FUNCTION(WRAP_PROTO VAR)
    ...
    # Add if somebody imports the pb.h.
...
IF(NOT PROTOBUF_FOUND)
  ...
  IF(PROTOBUF_FIND_REQUIRED)
    MESSAGE(FATAL_ERROR
            "ProtoBuf required but some headers or libs not found. Please specify it's location with PROTOBUF_DIR env. variable.")
  ELSE(PROTOBUF_FIND_REQUIRED)
    MESSAGE(STATUS 
            "ERROR: ProtoBuf was not found. Please specify it's location with PROTOBUF_DIR env. variable.")
